...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s silubium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  silubium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded silubium transaction") + "\n" +
              "  silubium-tx [options] -create [commands]   " + _("Create hex-encoded silubium transaction") + "\n" +
              "\n";
