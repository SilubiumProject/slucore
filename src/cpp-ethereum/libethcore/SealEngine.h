...
////////////////////////////////////////////////////////////// // silubium
	void setSilubiumSchedule(EVMSchedule _silubiumSchedule) const { silubiumSchedule = _silubiumSchedule; }

	EVMSchedule& getSilubiumSchedule() const { return silubiumSchedule; }
...
private:
	...
	mutable EVMSchedule silubiumSchedule; // silubium
