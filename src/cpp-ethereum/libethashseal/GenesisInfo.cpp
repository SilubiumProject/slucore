...
#include "genesis/silubiumMainNetwork.cpp"
#include "genesis/silubiumTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::silubiumMainNetwork: return c_genesisInfoSilubiumMainNetwork;
	case Network::silubiumTestNetwork: return c_genesisInfoSilubiumTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::silubiumMainNetwork: return c_genesisStateRootSilubiumMainNetwork;
	case Network::silubiumTestNetwork: return c_genesisStateRootSilubiumTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
