...
UniValue blockheaderToJSON(const CBlockIndex* blockindex)
{
    ...
    result.push_back(Pair("hashStateRoot", blockindex->hashStateRoot.GetHex())); // silubium
    result.push_back(Pair("hashUTXORoot", blockindex->hashUTXORoot.GetHex())); // silubium
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails)
{
    ...
    result.push_back(Pair("hashStateRoot", block.hashStateRoot.GetHex())); // silubium
    result.push_back(Pair("hashUTXORoot", block.hashUTXORoot.GetHex())); // silubium
