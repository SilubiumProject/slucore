...
UniValue getdgpinfo(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("maxblocksize", (uint64_t)silubiumDGP.getBlockSize(chainActive.Height()));
    obj.pushKV("mingasprice", (uint64_t)silubiumDGP.getMinGasPrice(chainActive.Height()));
    obj.pushKV("blockgaslimit", (uint64_t)silubiumDGP.getBlockGasLimit(chainActive.Height()));
...
UniValue getsilkwormnodeaddr(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
                "getsilkwormnodeaddr\n"
                "\nReturns an silkwormnodeaddr.\n"
                "\nResult:\n"
                " nodeaddr         (std::address) current silkwormaddress\n"
                "\nExamples:\n"
                + HelpExampleCli("getsilkwormnodeaddr", "")
                + HelpExampleRpc("getsilkwormnodeaddr", "")
                );
    ...
    SilubiumDGP silubiumDGP(globalState.get());
    return silubiumDGP.getMainNodeAddress(chainActive.Height());
}


UniValue getsilkwormminetime(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
                "getsilkwormminetime\n"
                "\nReturns an silkworm minimum minetime.\n"
                "\nResult:\n"
                "n         (numeric) minetime\n"
                "\nExamples:\n"
                + HelpExampleCli("getsilkwormminetime", "")
                + HelpExampleRpc("getsilkwormminetime", "")
                );
    ...
    SilubiumDGP silubiumDGP(globalState.get());
    return (int32_t)silubiumDGP.getMineTime (chainActive.Height());
}

UniValue getsilkwormminetimemax(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
                "getsilkwormminetimemax\n"
                "\nReturns an silkworm maximum minetime.\n"
                "\nResult:\n"
                "n         (numeric) minetime\n"
                "\nExamples:\n"
                + HelpExampleCli("getsilkwormminetimemax", "")
                + HelpExampleRpc("getsilkwormminetimemax", "")
                );
    ...
    SilubiumDGP silubiumDGP(globalState.get());
    return (int32_t)silubiumDGP.getMineTimeMax(chainActive.Height());
}
...
{ //  category              name                      actor (function)         argNames
  ...
  {"silkworm",            "getsilkwormminetime",    &getsilkwormminetime,     {}},
  {"silkworm",            "getsilkwormminetimemax",    &getsilkwormminetimemax,     {}},
  {"silkworm",            "getsilkwormnodeaddr",    &getsilkwormnodeaddr,     {}},
