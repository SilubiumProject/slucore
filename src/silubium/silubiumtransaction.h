#ifndef SILUBIUMTRANSACTION_H
#define SILUBIUMTRANSACTION_H
...
class SilubiumTransaction : public dev::eth::Transaction{

public:

    SilubiumTransaction() : nVout(0) {}

    SilubiumTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
		dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) {}

    SilubiumTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
