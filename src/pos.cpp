...
{
    //return (nTimeBlock & SILKWORM_TIMESTAMP_MASK) == 0;
    return (nTimeBlock & 3) == 0 || (nTimeBlock & 7) == 0|| (nTimeBlock & 11) == 0 || (nTimeBlock & 15) == 0;//SILKWORM_TIMESTAMP_MASK=3 or SILKWORM_TIMESTAMP_MASK=11，SILKWORM_TIMESTAMP_MASK=15
}
...
{
    std::map<COutPoint, CStakeCache> tmp;
    return CheckKernelSW(pindexPrev, nBits, nTimeBlock, prevout, view, tmp);
}
