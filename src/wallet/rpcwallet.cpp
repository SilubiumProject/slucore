...
extern UniValue encryptbypubkey(const JSONRPCRequest& request);
extern UniValue decryptbyprivkey(const JSONRPCRequest& request);
...
{ //  category              name                        actor (function)           okSafeMode
    ...
    { "wallet",             "sendtoaddress",            &sendtoaddress,            false,  {"address","amount","comment","comment_to","subtractfeefromamount","replaceable","conf_target","estimate_mode","senderAddress","changeToSender"} },
    ...
    { "util",               "dumppubkey",               &dumppubkey,                true,  {"address"} },
//    { "util",               "encryptbypubkey",          &encryptbypubkey,           true,   {"pubkey","information"}},
//    { "util",               "decryptbyprivkey",         &decryptbyprivkey,          true,   {"address","encrypt-information"}},
};
