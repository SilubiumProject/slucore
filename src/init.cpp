...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-showdbg", "Show advanced user functions", false, OptionsCategory::OPTIONS);
    gArgs.AddArg("-enablemainnode", "Enable Mainnode", false, OptionsCategory::OPTIONS);
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://www.silktraderdk.net>";
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                pstorageresult.reset(new StorageResults(silubiumStateDir.string()));
                if (fReset) {
