    ...
    mapper(0)
{
    ...
    if(!gArgs.IsArgSet("-showdbg"))
        ...
        ui->openBitcoinConfButton->setVisible(false);
...
//    ui->thirdPartyTxUrls->setPlaceholderText("https://silkchain2.silubium.org/transaction/%s");
    ui->thirdPartyTxUrlsLabel->hide();
    ui->thirdPartyTxUrls->hide();
    ui->thirdPartyTxUrls->setText("https://silkchain2.silubium.org/transaction/%s");
//#endif
