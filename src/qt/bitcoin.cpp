...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Silubium can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
bool CheckAndUpdate()
{
    SilubiumVersionChecker *silubiumVersionChecker = new SilubiumVersionChecker();
