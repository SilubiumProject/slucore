...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SLU");
    case mBTC: return QString("mSLU");
    case uBTC: return QString::fromUtf8("μSLU (bits)");
...
QString BitcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uBTC: return QString::fromUtf8("μSLU");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Slus");
    case mBTC: return QString("Milli-Slus (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Slus (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
