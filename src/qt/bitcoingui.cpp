...
void BitcoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    {
        // Check for updates
        if(_clientModel->getOptionsModel()->getCheckForUpdates() && silubiumVersionChecker->newVersionAvailable())
        {
...
{
    QDesktopServices::openUrl(QUrl(QString("https://www.silktraderdk.net")));
}
