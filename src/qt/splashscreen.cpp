    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QRect rectBg(QPoint(0, -50), QSize(splashSize.width(), splashSize.height() + 50));
    QPixmap bg(":/styles/app-icons/splash_bg");
    pixPaint.drawPixmap(rectBg, bg);

    pixPaint.setFont(QFont(font, 32*fontFactor, QFont::Bold));
    QRect rectTitle(QPoint(11,0), QSize(splashSize.width(), (splashSize.height() / 2)));
    ...
    QRect versionRect(QPoint(8,260), QSize(rectTitle.width(), versionTextHeight));
