...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // silubium
        hashUTXORoot.SetNull(); // silubium
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //silubium
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //silubium
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //silubium
    {
