...
class DeprecatedRpcTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        SOME_ADDRESS = convert_btc_address_to_silubium("mnvGjUy3NMj67yJ6gkK5o9e5RS33Z2Vqcu")  # This is just some random address to pass as a parameter to validateaddress
