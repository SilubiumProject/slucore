...
from .silubiumconfig import COINBASE_MATURITY
...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def main(self):
        ...
        self.options.bitcoind = os.getenv("BITCOIND", default=config["environment"]["BUILDDIR"] + '/src/silubiumd' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("BITCOINCLI", default=config["environment"]["BUILDDIR"] + '/src/silubium-cli' + config["environment"]["EXEEXT"])
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                ...
                for entry in os.listdir(cache_path(i)):
                    if entry not in ['chainstate', 'blocks', 'stateSilubium']:
