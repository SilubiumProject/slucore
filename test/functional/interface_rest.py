...
import http.client
import urllib.parse
from test_framework.silubiumconfig import COINBASE_MATURITY, INITIAL_BLOCK_REWARD
...
class RESTTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        not_related_address = convert_btc_address_to_silubium("2MxqoHEdNQTyYeX1mHcbrrpzgojbosTpCvJ")
