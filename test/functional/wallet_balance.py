...
from test_framework.silubiumconfig import INITIAL_BLOCK_REWARD, COINBASE_MATURITY

RANDOM_COINBASE_ADDRESS = convert_btc_address_to_silubium('mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ')
...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("We use a third node here that sends 50 silubium to each of the two other nodes to keep compatibility with bitcoin")
