...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        address_info = self.nodes[0].getaddressinfo(convert_btc_address_to_silubium("mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ"))
        assert_equal(address_info['address'], convert_btc_address_to_silubium("mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ"))
