...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see silubium-dgp.py
"""
class SilubiumDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the silubiumd to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    SilubiumDGPActivation().main()
